...
(Get-Content .\Lorem.NET\Lorem.NET.csproj).replace('$commitMsg', $Env:APPVEYOR_REPO_COMMIT_MESSAGE) | Set-Content .\Lorem.NET\Lorem.NET.csproj
(Get-Content .\Lorem.NET\Lorem.NET.csproj).replace('$commitMsgExtended', $Env:APPVEYOR_REPO_COMMIT_MESSAGE_EXTENDED) | Set-Content .\Lorem.NET\Lorem.NET.csproj
